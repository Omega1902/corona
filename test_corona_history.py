...
class TestLandkreise(unittest.TestCase):
    ...
    table = [['Köln', '32.8', '31.1', '27.6', '26.7', '23.7', '18.3', '20.2'], ['Nordfriesland', '27.7', '24.1', '22.9', '21.1', '16.3', '10.2', '6.6'], ['Oberbergischer Kreis', '43.0', '39.3', '36.0', '31.6', '30.9', '26.5', '19.5'], ['Wolfsburg', '35.4', '28.9', '30.6', '32.2', '25.7', '14.5', '7.2']]
    graph_data = [
    ...
    germany_inzidenzen = [29.677739690824133, 26.2532926184853, 24.71541768677133, 24.289766611066298, 22.920228262964493, 20.764317588560164, 19.255300356893997]
